...
varThresh1 = 0.9   #the threshold of variance
sel = VarianceThreshold(varThresh1)
...
np.savetxt("./Data/data_reduction/data_train"+ "_fs1_"+str(varThresh1)+"_"+str(dim)+".txt", train_data)
# np.savetxt("./Data/data_reduction/label_train.txt", train_label)
np.savetxt("./Data/data_reduction/data_test"+"_fs1_"+str(varThresh1)+"_"+str(dim)+".txt", test_data)
